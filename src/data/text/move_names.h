...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_HEAD_CHARGE] = _("Feral Charge"),
    ...
    [MOVE_STARSHIELD_BASH] = _("StrshieldBash"),
    ...
    [MOVE_TWIRL] = _("Twirl"),
    [MOVE_FLURRY_KICK] = _("Flurry Kick"),
    [MOVE_BURNING_CINDERS] = _("BurningCindrs"),
    [MOVE_FLYBY] = _("Flyby"),
    [MOVE_METEOR_SHOWER] = _("MeteorShower"),
    [MOVE_VOLCALITH] = _("Volcalith"),
    // Max Moves
...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_EERIE_SPELL] = _("Eerie Spell"),
    [MOVE_DIRE_CLAW] = _("Dire Claw"),
    [MOVE_STARSHIELD_BASH] = _("StrshieldBsh"),
    [MOVE_POWER_SHIFT] = _("Power Shift"),
    [MOVE_STONE_AXE] = _("Stone Axe"),
    ...
    [MOVE_SYRUP_BOMB] = _("Syrup Bomb"),
    [MOVE_IVY_CUDGEL] = _("Ivy Cudgel"),
    [MOVE_MOONSAULT_SLAM] = _("MoonsaltSlam"),
    [MOVE_SHRIEK] = _("Shriek"),
    [MOVE_GLITTER_FANG] = _("Glitter Fang"),
    [MOVE_FLASH_FREEZE] = _("Flash Freeze"),
    [MOVE_DEATH_ROLL] = _("Death Roll"),
    ...
    [MOVE_TWIRL] = _("Twirl"),
    [MOVE_FLURRY_KICK] = _("FlurryKick"),
    [MOVE_BURNING_CINDERS] = _("BrningCindrs"),
    [MOVE_FLYBY] = _("Flyby"),
    [MOVE_METEOR_SHOWER] = _("MteorShowr"),
    [MOVE_VOLCALITH] = _("Volcalith"),
    // Max Moves
