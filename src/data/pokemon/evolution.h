const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]                = {{EVO_LEVEL, 42, SPECIES_CROBAT}},
    ...
    [SPECIES_MEOWTH]                = {{EVO_ITEM, ITEM_AMULET_COIN, SPECIES_PERSIAN}},
    ...
    [SPECIES_KRABBY]                = {{EVO_LEVEL, 38, SPECIES_KINGLER}},
    ...
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 35, SPECIES_MAROWAK},
    ...
    [SPECIES_LEDYBA]                = {{EVO_LEVEL, 24, SPECIES_LEDIAN}},
    ...
    [SPECIES_SKIPLOOM]              = {{EVO_LEVEL, 37, SPECIES_JUMPLUFF}},
...
#endif
    [SPECIES_WOOPER]                = {{EVO_LEVEL, 25, SPECIES_QUAGSIRE}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_HOUNDOUR]              = {{EVO_LEVEL, 34, SPECIES_HOUNDOOM}},
...
#endif
    [SPECIES_TYROGUE]               = {{EVO_ITEM, ITEM_X_DEFENSE, SPECIES_HITMONCHAN},
                                       {EVO_ITEM, ITEM_X_ATTACK, SPECIES_HITMONLEE},
                                       {EVO_ITEM, ITEM_GUARD_SPEC, SPECIES_HITMONTOP}},
    [SPECIES_SMOOCHUM]              = {{EVO_ITEM, ITEM_HEART_SCALE, SPECIES_JYNX}},
    ...
    [SPECIES_WURMPLE]               = {{EVO_LEVEL_SILCOON, 9, SPECIES_SILCOON},
                                       {EVO_LEVEL_CASCOON, 9, SPECIES_CASCOON}},
    [SPECIES_SILCOON]               = {{EVO_LEVEL, 18, SPECIES_BEAUTIFLY}},
    [SPECIES_CASCOON]               = {{EVO_LEVEL, 18, SPECIES_DUSTOX}},
    ...
    [SPECIES_SURSKIT]               = {{EVO_LEVEL, 32, SPECIES_MASQUERAIN}},
    [SPECIES_WAILMER]               = {{EVO_LEVEL, 40, SPECIES_WAILORD}},
    [SPECIES_SKITTY]                = {{EVO_ITEM, ITEM_FLUFFY_TAIL, SPECIES_DELCATTY}},
...
#endif
    [SPECIES_SLAKOTH]               = {{EVO_LEVEL, 26, SPECIES_VIGOROTH}},
    [SPECIES_VIGOROTH]              = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_SLAKING}},
    ...
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 52, SPECIES_AGGRON}},
    ...
    [SPECIES_KIRLIA]                = {{EVO_LEVEL_FEMALE, 32, SPECIES_GARDEVOIR},
                                    #if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_BUDEW]                 = {{EVO_LEVEL, 30, SPECIES_ROSELIA}},
    ...
    [SPECIES_BONSLY]                = {{EVO_LEVEL, 37, SPECIES_SUDOWOODO}},
    ...
    [SPECIES_TEPIG]                 = {{EVO_LEVEL, 18, SPECIES_PIGNITE}},
    ...
    [SPECIES_BLITZLE]               = {{EVO_LEVEL, 34, SPECIES_ZEBSTRIKA}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                       {EVO_ITEM, ITEM_X_ATTACK, SPECIES_LILLIGANT_HISUIAN}},
    ...
    [SPECIES_KARRABLAST]            = {{EVO_ITEM, ITEM_X_DEFENSE, SPECIES_ESCAVALIER}},
    ...
    [SPECIES_SHELMET]               = {{EVO_LEVEL, ITEM_X_SPEED, SPECIES_ACCELGOR}},
    ...
    [SPECIES_TRUMBEAK]              = {{EVO_LEVEL, 38, SPECIES_TOUCANNON}},
    [SPECIES_YUNGOOS]               = {{EVO_LEVEL, 26, SPECIES_GUMSHOOS}},
    [SPECIES_GRUBBIN]               = {{EVO_LEVEL, 30, SPECIES_CHARJABUG}},
    ...
    [SPECIES_MUDBRAY]               = {{EVO_LEVEL, 32, SPECIES_MUDSDALE}},
    ...
    [SPECIES_BLIPBUG]               = {{EVO_LEVEL, 12, SPECIES_DOTTLER}},
    ...
    [SPECIES_CHEWTLE]               = {{EVO_LEVEL, 32, SPECIES_DREDNAW}},
    [SPECIES_YAMPER]                = {{EVO_LEVEL, 25, SPECIES_BOLTUND}},
    [SPECIES_ROLYCOLY]              = {{EVO_LEVEL, 18, SPECIES_CARKOL}},
    [SPECIES_CARKOL]                = {{EVO_LEVEL, 46, SPECIES_COALOSSAL}},
    ...
    [SPECIES_SINISTEA]              = {{EVO_ITEM, ITEM_CHIPPED_POT, SPECIES_POLTEAGEIST}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_LEVEL, 42, SPECIES_GOLEM_ALOLAN}},
...
#endif
#if P_GEN_6_POKEMON == TRUE
    [SPECIES_FLABEBE_YELLOW_FLOWER] = {{EVO_LEVEL, 20, SPECIES_FLOETTE_YELLOW_FLOWER}},
    [SPECIES_FLABEBE_ORANGE_FLOWER] = {{EVO_LEVEL, 20, SPECIES_FLOETTE_ORANGE_FLOWER}},
    [SPECIES_FLABEBE_BLUE_FLOWER]   = {{EVO_LEVEL, 20, SPECIES_FLOETTE_BLUE_FLOWER}},
    [SPECIES_FLABEBE_WHITE_FLOWER]  = {{EVO_LEVEL, 20, SPECIES_FLOETTE_WHITE_FLOWER}},
    ...
    [SPECIES_LUVDISC]               = {{EVO_LEVEL, 38, SPECIES_ALOMOMOLA}},
    [SPECIES_BASCULIN]              = {{EVO_LEVEL, 45, SPECIES_BASCULEGION}},
    [SPECIES_BASCULIN_BLUE_STRIPED] = {{EVO_LEVEL, 45, SPECIES_BASCULEGION}},
    [SPECIES_BASCULIN_WHITE_STRIPED]= {{EVO_LEVEL, 45, SPECIES_BASCULEGION}},
    [SPECIES_CARBINK]               = {{EVO_LEVEL, 78, SPECIES_DIANCIE}},
    ...
    [SPECIES_ROTOM_HEAT]            = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ROTOM_FAN},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW}},
    [SPECIES_ROTOM_WASH]            = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ROTOM_FAN},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW}},
    [SPECIES_ROTOM_FROST]           = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ROTOM_FAN},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW}},
    [SPECIES_ROTOM_FAN]            = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ROTOM},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW}},
    [SPECIES_ROTOM_MOW]            = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT},
                                       {EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ROTOM_FAN},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM}},
#endif
};
