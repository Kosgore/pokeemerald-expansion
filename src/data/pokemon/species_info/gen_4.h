...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_RUN_AWAY },
    ...
    [SPECIES_MONFERNO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE },
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_UNSEEN_FIST },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_MONSTER },
        .abilities = { ABILITY_STURDY, ABILITY_NONE, ABILITY_SIEGE_MACHINE },
        ...
        LEARNSETS(Shieldon),
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_BASTIODON}),
    },
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_MONSTER },
        .abilities = { ABILITY_DAUNTLESS_SHIELD, ABILITY_NONE, ABILITY_SIEGE_MACHINE },
        .bodyColor = BODY_COLOR_GRAY,
...
#define GASTRODON_MISC_INFO                                                             \
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        LEARNSETS(Buneary),
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_STOMP, SPECIES_LOPUNNY}),
    },
...
#define LOPUNNY_MISC_INFO                                       \
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .expYield = 168,
        .abilities = { ABILITY_IRON_HEEL, ABILITY_SCRAPPY, ABILITY_LIMBER },
        .cryId = CRY_LOPUNNY,
        .height = 12,
        .weight = 333,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_LINGERING_AROMA, ABILITY_STENCH, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_PURPLE,
        ...
        LEARNSETS(Stunky),
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_SKUNTANK}),
    },
...
#define LUCARIO_MISC_INFO                                       \
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_SAND_SPIT, ABILITY_OBLIVIOUS, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_HIPPOWDON}),
    },
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_SAND_SPIT, ABILITY_STRONG_JAW, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
