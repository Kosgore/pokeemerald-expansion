...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_UNBURDEN, ABILITY_LIMBER, ABILITY_PROTEAN },
...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_FLARE_BOOST, ABILITY_FLAME_BODY, ABILITY_BIG_PECKS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_INCENDIARY, ABILITY_FLAME_BODY, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_RED,
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_RIVALRY, ABILITY_FLASH_FIRE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_BLOOM_TENDER, ABILITY_FLOWER_VEIL, ABILITY_SYMBIOSIS },  \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        LEARNSETS(Skiddo),
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_GOGOAT}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = { ABILITY_AROMA_VEIL, ABILITY_LINGERING_AROMA, ABILITY_CURIOUS_MEDICINE },
    ...
    [SPECIES_AROMATISSE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = { ABILITY_AROMA_VEIL, ABILITY_NEUTRALIZING_GAS, ABILITY_CURIOUS_MEDICINE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_HELIOPTILE] =
    {
        ...
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_NONE, ABILITY_SHED_SKIN },
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_PLUS, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_GOOEY, ABILITY_LIQUID_OOZE, ABILITY_SAP_SIPPER },
...
,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
            ...
            .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        #endif
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_INFILTRATOR, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
            ...
            .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        #endif
        .abilities = { ABILITY_CACOPHONY, ABILITY_INFILTRATOR, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_PURPLE,
