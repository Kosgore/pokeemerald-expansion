...
#define GRENINJA_MISC_INFO                              \
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_NONE, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_GALE_WINGS, ABILITY_NONE, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_RED,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_PLUS, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_YELLOW,
