const struct Trainer gTrainers[] = {
    ...
    [TRAINER_GRUNT_MT_CHIMNEY_1] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SMART_SWITCHING | AI_FLAG_DOUBLE_BATTLE | AI_FLAG_HP_AWARE,
    ...
    [TRAINER_TATE_AND_LIZA_1] =
    {
        ...
        .items = {},
        .doubleBattle = TRUE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_SMART_SWITCHING | AI_FLAG_HP_AWARE | AI_FLAG_DOUBLE_BATTLE | AI_FLAG_ACE_POKEMON,
