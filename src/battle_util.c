...
static const u8 sHoldEffectToType[][2] =
{
    ...
    {HOLD_EFFECT_PRIMAL_POWER, TYPE_PRIMAL},
};
...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Cosmic  Primal
    [TYPE_NORMAL]   = {______, ______, ______, ______, ______, X(0.5), ______, X(0.0), X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______},
    [TYPE_FIGHTING] = {X(2.0), ______, X(0.5), X(0.5), ______, X(2.0), X(0.5), X(0.0), X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), X(0.5), ______, X(2.0)},
    ...
    [TYPE_POISON]   = {______, ______, ______, X(0.5), X(0.5), X(0.5), X(2.0), X(0.5), X(0.0), ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), ______, X(2.0)},
    ...
    [TYPE_ROCK]     = {______, X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, ______, X(2.0), ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______},
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(2.0), ______, ______},
    ...
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, ______, X(2.0), ______, ______},
    ...
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(2.0), X(0.5), ______, ______, X(0.5), ______},
    [TYPE_WATER]    = {______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, ______, X(0.5), ______, ______, ______, X(0.5)},
    ...
    [TYPE_ICE]      = {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, ______, ______, X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, X(2.0), ______},
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, X(2.0), ______, X(0.0), X(0.5), ______},
    [TYPE_DARK]     = {______, X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5), X(2.0), X(0.5)},
    [TYPE_FAIRY]    = {______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______, X(0.5), ______},
    [TYPE_COSMIC]   = {______, ______, X(2.0), X(0.5), X(0.5), X(0.5), ______, X(2.0), ______, X(0.5), X(2.0), ______, ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, ______},
    [TYPE_PRIMAL]   = {X(2.0), ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(0.5), X(2.0)},
};
...
u8 DoBattlerEndTurnEffects(void)
{
    ...
    while (gBattleStruct->turnEffectsBattlerId < gBattlersCount && gBattleStruct->turnEffectsTracker <= ENDTURN_BATTLER_COUNT)
    {
        ...
        case ENDTURN_BURN:  // burn
            ...
            gBattleStruct->turnEffectsTracker++;
            break;
        case ENDTURN_FROSTBITE:  // cold burn
    ...
    do
    {
        ...
        case CANCELLER_CONFUSED: // confusion
            if (!gBattleStruct->isAtkCancelerForCalledMove && gBattleMons[gBattlerAttacker].status2 & STATUS2_CONFUSION)
            {
                ...
                {
                     // confusion dmg
                    if (RandomWeighted(RNG_CONFUSION, (B_CONFUSION_SELF_DMG_CHANCE >= GEN_7 ? 2 : 1), 1) && GetBattlerAbility(gBattlerTarget) != ABILITY_TANGLED_FEET)
                    {
...
static bool32 TryChangeBattleTerrain(u32 battler, u32 statusFlag, u8 *timer)
{
    ...
    {
        gFieldStatuses &= ~(STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_GRAVITY | STATUS_FIELD_MUDSPORT | STATUS_FIELD_WATERSPORT);
...
u32 AbilityBattleEffects(u32 caseID, u32 battler, u32 ability, u32 special, u32 moveArg)
{
    ...
    case ABILITYEFFECT_ON_SWITCHIN: // 0
        ...
        case ABILITY_GRAVITY_WELL:
            ...
            break;
        case ABILITY_MUDDY:
            if (TryChangeBattleTerrain(battler, STATUS_FIELD_MUDSPORT, &gFieldTimers.mudSportTimer))
            {
        ...
        case ABILITY_INTIMIDATE:
            ...
            break;
        case ABILITY_DEMORALIZE:
            if (!gSpecialStatuses[battler].switchInAbilityDone)
            {
                gBattlerAttacker = battler;
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
                SET_STATCHANGER(STAT_SPATK, 1, TRUE);
                BattleScriptPushCursorAndCallback(BattleScript_DemoralizeActivates);
                effect++;
            }
            break;
        case ABILITY_TRACE:
    ...
    case ABILITYEFFECT_MOVE_END: // Think contact abilities.
        ...
        case ABILITY_ICE_BODY:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             ...
             && TARGET_TURN_DAMAGED
             && CanBeBurned(gBattlerAttacker, gBattlerTarget)
             && RandomWeighted(RNG_ICE_BODY, 2, 1))
            {
    ...
    case ABILITYEFFECT_MOVE_END_ATTACKER: // Same as above, but for attacker
        ...
        case ABILITY_REVERBERATION:
            if (!(gMoveResultFlags & MOVE_RESULT_NO_EFFECT)
             && gBattleMons[gBattlerTarget].hp != 0
             && (CompareStat(gBattlerTarget, STAT_SPDEF, MIN_STAT_STAGE, CMP_GREATER_THAN) || GetBattlerAbility(gBattlerTarget) == ABILITY_MIRROR_ARMOR)
             && !gProtectStructs[gBattlerAttacker].confusionSelfDmg
             && TARGET_TURN_DAMAGED
             && IsMoveMakingContact(move, gBattlerAttacker)
             && (Random() % 3) == 0)
...
{
    u16 ability = GetBattlerAbility(battlerTarget);
    if (IS_BATTLER_OF_TYPE(battlerTarget, TYPE_FIRE)
      || gSideStatuses[GetBattlerSide(battlerTarget)] & SIDE_STATUS_SAFEGUARD
      || gBattleMons[battlerTarget].status1 & STATUS1_ANY
      || ability == ABILITY_WATER_VEIL
      || ability == ABILITY_WATER_BUBBLE
      || ability == ABILITY_MUDDY
      || ability == ABILITY_COMATOSE
...
bool32 IsBattlerProtected(u32 battler, u32 move)
{
    ...
    if (gProtectStructs[battler].maxGuarded && IsMoveBlockedByMaxGuard(move))
        return TRUE;
    if (GetBattlerAbility(gBattlerAttacker) == ABILITY_WRAITH_GRIP
        && (gBattleMoves[move].type == TYPE_GHOST))
        return FALSE;
...
static inline u32 CalcAttackStat(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 isCrit, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk)
{
    ...
    if (IsAbilityOnField(ABILITY_PRESSURE) && (atkAbility != ABILITY_PRESSURE || atkAbility != ABILITY_INNER_FOCUS || atkAbility != ABILITY_OBLIVIOUS))
...
static inline void MulByTypeEffectiveness(uq4_12_t *modifier, u32 move, u32 moveType, u32 battlerDef, u32 defType, u32 battlerAtk, bool32 recordAbilities)
{
    ...
    if ((moveType == TYPE_PSYCHIC) && defType == TYPE_DARK && GetBattlerAbility(battlerAtk) == ABILITY_TELEPATHY && mod == UQ_4_12(0.0))
    {
        mod = UQ_4_12(1.0);
        if (recordAbilities)
            RecordAbilityBattle(battlerAtk, ABILITY_TELEPATHY);
    }
